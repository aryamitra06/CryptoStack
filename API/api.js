...
const apiurl = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=10&sparkline=false";
...
export const fetchData = async(pageno) =>{
    try{
        return axios.get(`${apiurl}&page=${pageno}`);
    }
    catch(error){
        console.log(error);
    }
